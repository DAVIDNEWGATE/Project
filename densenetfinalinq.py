...
def run_model(data, image_dim, label_count, depth):
  ...
  load_path = 'inqfinal/'+name+'.ckpt'
  #normal save path  
  normal_savepath = 'inqfinal2/'+name+'_%d.ckpt'
  #best result save path
  best_savepath = 'inqfinal3/'+name+'_%d_%d.ckpt'
  ...
  final_acc = 0.0
  best_acc = 0.0
  #See loaded results&adjust learning rate
